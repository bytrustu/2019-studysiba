...
public class PageController extends HttpServlet {
  ...
  public void init(ServletConfig config) throws ServletException {
    loadProperties("com.bytrustu.page.properties/PageCommand");
  }
  ...
  private void loadProperties(String filePath) {
    ...
    while (actionEnum.hasMoreElements()) {
      ...
      try {
        ...
        if (className.equals("com.bytrustu.page.action.PageFormChangeAction")) {
          PageFormChangeAction mf = (PageFormChangeAction) actionInstance;
