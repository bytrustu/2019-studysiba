...
public class ChatController extends HttpServlet {
   ...
   // 서블릿 호출시 init 부터 실행 , 이동 될 경로에 해당되는 HashMap key values 값이 저장 된 properties 파일을 로드
      ...
      loadProperties("com.bytrustu.chat.properties/ChatCommand");
    }
    ...
    private void loadProperties(String filePath) {
      ...
      while (actionEnum.hasMoreElements()) {
        ...
        try {
          ...
          if(className.equals("com.bytrustu.chat.action.ChatFormChangeAction")){
            ChatFormChangeAction bf = (ChatFormChangeAction) actionInstance;
