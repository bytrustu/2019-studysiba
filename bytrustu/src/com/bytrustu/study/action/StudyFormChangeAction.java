...
public class StudyFormChangeAction implements Action {

  // contentPage 경로값 기본 path
  private String form = "SubForm.jsp?contentPage=study/";
  private String path;
  
  // command *.bo 입력값 앞까지 잘라서 입력받은 name 값을 받아온다.
  ...
  public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    // *.bo 확장자 패턴으로 시작되는 경우 content 값의 경로를 기본으로 path 값을 추가해서 지정
    }else{
